...
async function main(inputValue, inputType = 'chat', outputType = 'chat', stream = false) {
    const flowIdOrName = 'e8f88c8e-6f3c-4e77-b072-5ad14cf18eb9';
    const langflowId = 'e914f8eb-eb52-48f3-91d0-5f8a425ff929';
    ...
    try {
      const tweaks = {
  "ChatInput-blXIL": {},
  "AstraDBToolComponent-jxcoC": {},
  "ParseData-fFZMk": {},
  "Prompt-DrLel": {},
  "GoogleGenerativeAIModel-tAtXE": {},
  "ChatOutput-oNmsK": {}
};
